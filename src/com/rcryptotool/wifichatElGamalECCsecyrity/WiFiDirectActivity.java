...
import static com.rcryptotool.wifichatElGamalECCsecyrity.Constants.*;
...
import com.rcryptotool.wifichatElGamalECCsecyrity.DeviceListFragment.DeviceActionListener;
...
public class WiFiDirectActivity extends Activity implements DeviceActionListener {
    ...
    private String encryption = "secp112r1";
    ...
    public void setEncryption () {
    	mApp.setEncryptionString(encryption);
    	mApp.setEnableEncryption(enabled);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.about:
            	...
            	Toast.makeText(this, "RCryptoChat Application", Toast.LENGTH_LONG).show();
            	return true;
            	
            case R.id.encryptionBits:
            	PTPLog.d(TAG, "onOptionsItemSelected : encryptionBits ");
            	Toast.makeText(this, "Choose Encryption ", Toast.LENGTH_LONG).show();
            	
            	final CharSequence[] items = {"ECC 112Bits", "ECC 160Bits", "ECC 256Bits", "RSA x-bits"};

            	AlertDialog.Builder builder = new AlertDialog.Builder(this);
            	builder.setTitle("Choose Encryption Strength");
            	builder.setItems(items, new DialogInterface.OnClickListener() {
            	    public void onClick(DialogInterface dialog, int item) {
            	        Toast.makeText(getApplicationContext(), items[item], Toast.LENGTH_SHORT).show();
            	        if (item == 0)
            	        	encryption = "secp112r1";
            	        else if (item == 1)
            	        	encryption = "secp160r1";
            	        else
            	        	encryption = "secp256r1";
            ...
            case R.id.encryptionOnOff:
            	PTPLog.d(TAG, "onOptionsItemSelected : encryptionBits ");
            	Toast.makeText(this, "Choose Encryption ", Toast.LENGTH_LONG).show();
            	
            	final CharSequence[] items_1 = {"Enable ECC Encryption", "Disable ECC Encryption"};

            	AlertDialog.Builder builder_1 = new AlertDialog.Builder(this);
            	builder_1.setTitle("Enable/Disable Encryption");
            	builder_1.setItems(items_1, new DialogInterface.OnClickListener() {
            	    public void onClick(DialogInterface dialog, int item) {
            	        Toast.makeText(getApplicationContext(), items_1[item], Toast.LENGTH_SHORT).show();
            	        if (item == 0)
            	        	enabled = true;
            	        else if (item == 1)
            	        	enabled = false;
            	       System.out.println ("Enabled Encryption = "+enabled); 
            	       setEncryption();          	       
            	    }
            	});
