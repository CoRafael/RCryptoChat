...
public class ECKey implements Key {
    ...
    public Key createOtherPartyPublicKey(String num1, String num2) throws NotOnMotherException {
	Key temp = new ECKey(mother);
	((ECKey)temp).beta = new ECPoint (mother,new BigInteger(num1),new BigInteger(num2));
